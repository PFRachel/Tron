...
namespace JuegoTron
{
    ...
    public class ListaEnlazadaMoto
    {
        ...
        public void Add(Node gridNode)
        {
            ...
            gridNode.CuadroImagen.BackColor = colorMoto;//Violet;
        }
        public void MoverConCombustible(Node newGridNode)
        {
            ...
            {
                // Si no hay combustible, puedes mostrar un mensaje o destruir la moto
        ...
        public void Move(Node newGridNode)
        {
            ...
            //Actualizamos la posicion actual de la moto 
        ...
        //metodo para obtener el siguiente nodo en la direccion actual 
